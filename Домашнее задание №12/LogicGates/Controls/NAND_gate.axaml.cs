...
{
    public class NAND_gate : TemplatedControl
    {
        public static readonly StyledProperty<object?> ContentProperty =
            AvaloniaProperty.Register<NAND_gate, object?>(nameof(Content));
        ...
        public static readonly StyledProperty<byte> MinInputsProperty =
            AvaloniaProperty.Register<NAND_gate, byte>(nameof(MinInputs), defaultValue: 2);
        ...
        public static readonly StyledProperty<byte> MaxInputsProperty =
            AvaloniaProperty.Register<NAND_gate, byte>(nameof(MaxInputs), defaultValue: 5);
        ...
        public static readonly StyledProperty<byte> InputCountProperty =
            AvaloniaProperty.Register<NAND_gate, byte>(nameof(InputCount), defaultValue: 2, validate: ValidateInputCount);
        ...
        {
            if (e.NewValue is byte newInputCount && e.Sender is NAND_gate gate)
            {
        ...
        {
            if (e.NewValue is ObservableCollection<bool> newInputValues && e.Sender is NAND_gate gate)
            {
        ...
        public static readonly StyledProperty<ObservableCollection<bool>> InputValuesProperty =
            AvaloniaProperty.Register<NAND_gate, ObservableCollection<bool>>(nameof(InputValues), defaultValue: new ObservableCollection<bool>([false,false]));
        ...
        public static readonly StyledProperty<bool> OutputValueProperty =
            AvaloniaProperty.Register<NAND_gate, bool>(nameof(OutputValue));
        ...
        public static readonly StyledProperty<Standard> ViewStandardProperty =
            AvaloniaProperty.Register<NAND_gate, Standard>(nameof(ViewStandard), defaultValue: Standard.GOST);
        ...
        {
            if (e.NewValue is Standard std && e.Sender is NAND_gate gate)
            {
                if (std == Standard.GOST)
                {
                    gate.Content = gate._GOST;
                    if (gate.Label == "NAND") gate.Label = "х-ме";
                }
                else if (std == Standard.ANSI)
                {
                    gate.Content = gate._ANSI;
                    if (gate.Label == "х-ме") gate.Label = "NAND";
                }
            }
        }
        ...
        public static readonly StyledProperty<string?> LabelProperty =
            AvaloniaProperty.Register<NAND_gate, string?>(nameof(Label), defaultValue: "х-ме");
        public string? Label
        {
        ...
        private void OnLabelChanged(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is string label && e.Sender is NAND_gate gate)
            {
                gate.Label = label;
                gate.DrawControl();
            }
        ...
        {
            DrawControl();
            InputCountProperty.Changed.AddClassHandler<NAND_gate>((sender, e) => OnInputCountChanged(e));
            InputValuesProperty.Changed.AddClassHandler<NAND_gate>((sender, e) => OnInputValuesChanged(e));
            InputValuesProperty.Changed.AddClassHandler<NAND_gate>((sender, e) => LogicalOperation(e));
            ViewStandardProperty.Changed.AddClassHandler<NAND_gate>((sender, e) => OnViewStandardPropertyChanged(e));
            LabelProperty.Changed.AddClassHandler<NAND_gate>((sender, e) => OnLabelChanged(e));
            OutputValueProperty.Changed.AddClassHandler<NAND_gate>((sender, e) => Console.WriteLine("lol"));
            Content = _GOST;
            this.Focusable = true;
        ...
        public void DrawControl()
        {
            ...
            var triangleGeometry = Geometry.Parse("M 0 0 L 0 80 L 40 80 A 30 30 135 1 0 40 0 Z");
