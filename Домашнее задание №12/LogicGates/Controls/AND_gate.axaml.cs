...
{
    public class AND_gate : TemplatedControl
    {
        public static readonly StyledProperty<object?> ContentProperty =
            AvaloniaProperty.Register<AND_gate, object?>(nameof(Content));
        ...
        public static readonly StyledProperty<byte> MinInputsProperty =
            AvaloniaProperty.Register<AND_gate, byte>(nameof(MinInputs), defaultValue: 2);
        ...
        public static readonly StyledProperty<byte> MaxInputsProperty =
            AvaloniaProperty.Register<AND_gate, byte>(nameof(MaxInputs), defaultValue: 5);
        ...
        public static readonly StyledProperty<byte> InputCountProperty =
            AvaloniaProperty.Register<AND_gate, byte>(nameof(InputCount), defaultValue: 2, validate: ValidateInputCount);
        ...
        {
            if (e.NewValue is byte newInputCount && e.Sender is AND_gate gate)
            {
        ...
        {
            if (e.NewValue is ObservableCollection<bool> newInputValues && e.Sender is AND_gate gate)
            {
        ...
        public static readonly StyledProperty<ObservableCollection<bool>> InputValuesProperty =
            AvaloniaProperty.Register<AND_gate, ObservableCollection<bool>>(nameof(InputValues), defaultValue: new ObservableCollection<bool>([false,false]));
        ...
        public static readonly StyledProperty<bool> OutputValueProperty =
            AvaloniaProperty.Register<AND_gate, bool>(nameof(OutputValue));
        ...
        public static readonly StyledProperty<Standard> ViewStandardProperty =
            AvaloniaProperty.Register<AND_gate, Standard>(nameof(ViewStandard), defaultValue: Standard.GOST);
        ...
        {
            if (e.NewValue is Standard std && e.Sender is AND_gate gate)
            {
                if (std == Standard.GOST)
                {
                    gate.Content = gate._GOST;
                    if (gate.Label == "AND") gate.Label = "È";
                }
                else if (std == Standard.ANSI)
                {
                    gate.Content = gate._ANSI;
                    if (gate.Label == "È") gate.Label = "AND";
                }
            }
        }

        public static readonly StyledProperty<string?> LabelProperty =
            AvaloniaProperty.Register<AND_gate, string?>(nameof(Label), defaultValue: "È");
        public string? Label
        {
        ...
        private void OnLabelChanged(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is string label && e.Sender is AND_gate gate)
            {
                gate.Label = label;
                gate.DrawControl();
            }
        ...
        {
            DrawControl();
            InputCountProperty.Changed.AddClassHandler<AND_gate>((sender, e) => OnInputCountChanged(e));
            InputValuesProperty.Changed.AddClassHandler<AND_gate>((sender, e) => OnInputValuesChanged(e));
            InputValuesProperty.Changed.AddClassHandler<AND_gate>((sender, e) => LogicalOperation(e));
            ViewStandardProperty.Changed.AddClassHandler<AND_gate>((sender, e) => OnViewStandardPropertyChanged(e));
            LabelProperty.Changed.AddClassHandler<AND_gate>((sender, e) => OnLabelChanged(e));
            OutputValueProperty.Changed.AddClassHandler<AND_gate>((sender, e) => Console.WriteLine("lol"));
            Content = _GOST;
            this.Focusable = true;
