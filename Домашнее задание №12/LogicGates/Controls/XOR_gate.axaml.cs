...
{
    public class XOR_gate : TemplatedControl
    {
        public static readonly StyledProperty<object?> ContentProperty =
            AvaloniaProperty.Register<XOR_gate, object?>(nameof(Content));
        ...
        public static readonly StyledProperty<byte> MinInputsProperty =
            AvaloniaProperty.Register<XOR_gate, byte>(nameof(MinInputs), defaultValue: 2);
        ...
        public static readonly StyledProperty<byte> MaxInputsProperty =
            AvaloniaProperty.Register<XOR_gate, byte>(nameof(MaxInputs), defaultValue: 5);
        ...
        public static readonly StyledProperty<byte> InputCountProperty =
            AvaloniaProperty.Register<XOR_gate, byte>(nameof(InputCount), defaultValue: 2, validate: ValidateInputCount);
        ...
        {
            if (e.NewValue is byte newInputCount && e.Sender is XOR_gate gate)
            {
        ...
        {
            if (e.NewValue is ObservableCollection<bool> newInputValues && e.Sender is XOR_gate gate)
            {
        ...
        public static readonly StyledProperty<ObservableCollection<bool>> InputValuesProperty =
            AvaloniaProperty.Register<XOR_gate, ObservableCollection<bool>>(nameof(InputValues), defaultValue: new ObservableCollection<bool>([false,false]));
        ...
        public static readonly StyledProperty<bool> OutputValueProperty =
            AvaloniaProperty.Register<XOR_gate, bool>(nameof(OutputValue));
        ...
        public static readonly StyledProperty<Standard> ViewStandardProperty =
            AvaloniaProperty.Register<XOR_gate, Standard>(nameof(ViewStandard), defaultValue: Standard.GOST);
        ...
        {
            if (e.NewValue is Standard std && e.Sender is XOR_gate gate)
            {
                if (std == Standard.GOST)
                {
                    gate.Content = gate._GOST;
                    if (gate.Label == "XOR") gate.Label = "Исключающее ИЛИ";
                }
                else if (std == Standard.ANSI)
                {
                    gate.Content = gate._ANSI;
                    if (gate.Label == "Исключающее ИЛИ") gate.Label = "XOR";
                }
            }
        }

        public static readonly StyledProperty<string?> LabelProperty =
            AvaloniaProperty.Register<XOR_gate, string?>(nameof(Label), defaultValue: "Исключающее ИЛИ");
        public string? Label
        {
        ...
        public static readonly StyledProperty<string> LabelFontProperty =
            AvaloniaProperty.Register<XOR_gate, string>(nameof(LabelFont), defaultValue: "Times New Roman", validate: ValidateFont);
        ...
        public static readonly StyledProperty<bool> IsSelectedProperty =
            AvaloniaProperty.Register<XOR_gate, bool>(nameof(IsSelected), defaultValue: false);
        ...
        private void OnLabelChanged(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is string label && e.Sender is XOR_gate gate)
            {
                gate.Label = label;
                gate.DrawControl();
            }
        ...
        {
            DrawControl();
            InputCountProperty.Changed.AddClassHandler<XOR_gate>((sender, e) => OnInputCountChanged(e));
            InputValuesProperty.Changed.AddClassHandler<XOR_gate>((sender, e) => OnInputValuesChanged(e));
            InputValuesProperty.Changed.AddClassHandler<XOR_gate>((sender, e) => LogicalOperation(e));
            ViewStandardProperty.Changed.AddClassHandler<XOR_gate>((sender, e) => OnViewStandardPropertyChanged(e));
            LabelProperty.Changed.AddClassHandler<XOR_gate>((sender, e) => OnLabelChanged(e));
            OutputValueProperty.Changed.AddClassHandler<XOR_gate>((sender, e) => Console.WriteLine("lol"));
            Content = _GOST;
            this.Focusable = true;
        ...
        private void LogicalOperation(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            {
                Console.WriteLine("xor calculate " + result + " ^ " + InputValues[i]);
        ...
        public void DrawControl()
        {
            ...
            var outputEllipse = new Ellipse
            {
                ...
                Height = 10,
                [Canvas.TopProperty] = 40,
                [Canvas.LeftProperty] = 90,
            };
            ANSI_Canvas.Children.Add(outputEllipse);
            var triangleGeometry = Geometry.Parse("M 0 0 Q 40 40 0 80 M 10 0 Q 50 40 10 80 L 50 80 Q 130 40 50 0 Z");
