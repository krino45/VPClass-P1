...
{
    public class XNOR_gate : TemplatedControl
    {
        public static readonly StyledProperty<object?> ContentProperty =
            AvaloniaProperty.Register<XNOR_gate, object?>(nameof(Content));
        ...
        public static readonly StyledProperty<byte> MinInputsProperty =
            AvaloniaProperty.Register<XNOR_gate, byte>(nameof(MinInputs), defaultValue: 2);
        ...
        public static readonly StyledProperty<byte> MaxInputsProperty =
            AvaloniaProperty.Register<XNOR_gate, byte>(nameof(MaxInputs), defaultValue: 5);
        ...
        public static readonly StyledProperty<byte> InputCountProperty =
            AvaloniaProperty.Register<XNOR_gate, byte>(nameof(InputCount), defaultValue: 2, validate: ValidateInputCount);
        ...
        {
            if (e.NewValue is byte newInputCount && e.Sender is XNOR_gate gate)
            {
        ...
        {
            if (e.NewValue is ObservableCollection<bool> newInputValues && e.Sender is XNOR_gate gate)
            {
        ...
        public static readonly StyledProperty<ObservableCollection<bool>> InputValuesProperty =
            AvaloniaProperty.Register<XNOR_gate, ObservableCollection<bool>>(nameof(InputValues), defaultValue: new ObservableCollection<bool>([false,false]));
        ...
        public static readonly StyledProperty<bool> OutputValueProperty =
            AvaloniaProperty.Register<XNOR_gate, bool>(nameof(OutputValue));
        ...
        public static readonly StyledProperty<Standard> ViewStandardProperty =
            AvaloniaProperty.Register<XNOR_gate, Standard>(nameof(ViewStandard), defaultValue: Standard.GOST);
        ...
        {
            if (e.NewValue is Standard std && e.Sender is XNOR_gate gate)
            {
                if (std == Standard.GOST)
                {
                    gate.Content = gate._GOST;
                    if (gate.Label == "XNOR") gate.Label = "Èñêëþ÷àþùåå ÈËÈ-ÍÅ";
                }
                else if (std == Standard.ANSI)
                {
                    gate.Content = gate._ANSI;
                    if (gate.Label == "Èñêëþ÷àþùåå ÈËÈ-ÍÅ") gate.Label = "XNOR";
                }
            }
        }

        public static readonly StyledProperty<string?> LabelProperty =
            AvaloniaProperty.Register<XNOR_gate, string?>(nameof(Label), defaultValue: "Èñêëþ÷àþùåå ÈËÈ-ÍÅ");
        public string? Label
        {
        ...
        public static readonly StyledProperty<string> LabelFontProperty =
            AvaloniaProperty.Register<XNOR_gate, string>(nameof(LabelFont), defaultValue: "Times New Roman", validate: ValidateFont);
        ...
        public static readonly StyledProperty<bool> IsSelectedProperty =
            AvaloniaProperty.Register<XNOR_gate, bool>(nameof(IsSelected), defaultValue: false);
        ...
        private void OnLabelChanged(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is string label && e.Sender is XNOR_gate gate)
            {
                gate.Label = label;
                gate.DrawControl();
            }
        ...
        {
            DrawControl();
            InputCountProperty.Changed.AddClassHandler<XNOR_gate>((sender, e) => OnInputCountChanged(e));
            InputValuesProperty.Changed.AddClassHandler<XNOR_gate>((sender, e) => OnInputValuesChanged(e));
            InputValuesProperty.Changed.AddClassHandler<XNOR_gate>((sender, e) => LogicalOperation(e));
            ViewStandardProperty.Changed.AddClassHandler<XNOR_gate>((sender, e) => OnViewStandardPropertyChanged(e));
            LabelProperty.Changed.AddClassHandler<XNOR_gate>((sender, e) => OnLabelChanged(e));
            Content = _GOST;
            this.Focusable = true;
