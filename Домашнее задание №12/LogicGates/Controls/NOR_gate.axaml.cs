...
{
    public class NOR_gate : TemplatedControl
    {
        public static readonly StyledProperty<object?> ContentProperty =
            AvaloniaProperty.Register<NOR_gate, object?>(nameof(Content));
        ...
        public static readonly StyledProperty<byte> MinInputsProperty =
            AvaloniaProperty.Register<NOR_gate, byte>(nameof(MinInputs), defaultValue: 2);
        ...
        public static readonly StyledProperty<byte> MaxInputsProperty =
            AvaloniaProperty.Register<NOR_gate, byte>(nameof(MaxInputs), defaultValue: 5);
        ...
        public static readonly StyledProperty<byte> InputCountProperty =
            AvaloniaProperty.Register<NOR_gate, byte>(nameof(InputCount), defaultValue: 2, validate: ValidateInputCount);
        ...
        {
            if (e.NewValue is byte newInputCount && e.Sender is NOR_gate gate)
            {
        ...
        {
            if (e.NewValue is ObservableCollection<bool> newInputValues && e.Sender is NOR_gate gate)
            {
        ...
        public static readonly StyledProperty<ObservableCollection<bool>> InputValuesProperty =
            AvaloniaProperty.Register<NOR_gate, ObservableCollection<bool>>(nameof(InputValues), defaultValue: new ObservableCollection<bool>([false,false]));
        ...
        public static readonly StyledProperty<bool> OutputValueProperty =
            AvaloniaProperty.Register<NOR_gate, bool>(nameof(OutputValue));
        ...
        public static readonly StyledProperty<Standard> ViewStandardProperty =
            AvaloniaProperty.Register<NOR_gate, Standard>(nameof(ViewStandard), defaultValue: Standard.GOST);
        ...
        {
            if (e.NewValue is Standard std && e.Sender is NOR_gate gate)
            {
                if (std == Standard.GOST)
                {
                    gate.Content = gate._GOST;
                    if (gate.Label == "NOR") gate.Label = "»À»-Õ≈";
                }
                else if (std == Standard.ANSI)
                {
                    gate.Content = gate._ANSI;
                    if (gate.Label == "»À»-Õ≈") gate.Label = "NOR";
                }
            }
        }

        public static readonly StyledProperty<string?> LabelProperty =
            AvaloniaProperty.Register<NOR_gate, string?>(nameof(Label), defaultValue: "»À»-Õ≈");
        public string? Label
        {
        ...
        public static readonly StyledProperty<string> LabelFontProperty =
            AvaloniaProperty.Register<NOR_gate, string>(nameof(LabelFont), defaultValue: "Times New Roman", validate: ValidateFont);
        ...
        public static readonly StyledProperty<bool> IsSelectedProperty =
            AvaloniaProperty.Register<NOR_gate, bool>(nameof(IsSelected), defaultValue: false);
        ...
        private void OnLabelChanged(AvaloniaPropertyChangedEventArgs e)
        {
            ...
            if (e.NewValue is string label && e.Sender is NOR_gate gate)
            {
                gate.Label = label;
                gate.DrawControl();
            }
        ...
        {
            DrawControl();
            InputCountProperty.Changed.AddClassHandler<NOR_gate>((sender, e) => OnInputCountChanged(e));
            InputValuesProperty.Changed.AddClassHandler<NOR_gate>((sender, e) => OnInputValuesChanged(e));
            InputValuesProperty.Changed.AddClassHandler<NOR_gate>((sender, e) => LogicalOperation(e));
            ViewStandardProperty.Changed.AddClassHandler<NOR_gate>((sender, e) => OnViewStandardPropertyChanged(e));
            LabelProperty.Changed.AddClassHandler<NOR_gate>((sender, e) => OnLabelChanged(e));
            OutputValueProperty.Changed.AddClassHandler<NOR_gate>((sender, e) => Console.WriteLine("lol"));
            Content = _GOST;
            this.Focusable = true;
